...
*   **Gestão Contábil Completa (Despesas e Lucro Líquido):** Painel financeiro reativo que calcula faturamento projetado (agendamentos), receitas efetivadas (pagas), despesas de operação (gastos como aluguel, maquinário, ferramentas, insumos) e o lucro líquido real do período filtrado. Oferece controle duplo em tabelas de receitas e despesas com registro de gastos via modal Glassmorphic.
