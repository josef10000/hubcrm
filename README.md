# 🔐 Hub Central — Intranet Corporativa v5.3.0 (Autonomous Automation)
...
- `VITE_GIPHY_API_KEY` (Obrigatório para GIFs no Chat)
  ...
  <p>
    <img src="https://img.shields.io/badge/Version-5.3.0-3b82f6?style=for-the-badge&labelColor=111111" alt="Version" />
  ...
  <div align="center">
  <h2>✨ Features em Destaque v5.3.0</h2>
</div>
...
| 🔔 **Lembretes (Remind Me)** | Agende notificações para mensagens específicas, transformando o chat em um gestor de tarefas. |
| 🖼️ **Sticker Management** | Controle total sobre a biblioteca de figurinhas, incluindo upload e exclusão de mídias personalizadas. |
