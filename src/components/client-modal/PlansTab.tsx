    ...
    <div className="space-y-6">
      ...
      {plans.length === 0 ? (
        <div className="bg-black/20 border border-white/5 rounded-2xl p-10 text-center">
          ...
          <p className="text-gray-500 italic">Este cliente ainda não possui planos adicionais contratados.</p>
        </div>
      ) : (
      ...
      <div className="mt-10 p-6 bg-primary-500/5 border border-primary-500/10 rounded-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            <span className="text-[10px] text-gray-500 font-bold uppercase block mb-1">Status</span>
